...
// Dark overlay fade out on scroll
gsap.to("#darkOverlay", {
    opacity: 0,
    delay:1,
    scrollTrigger: {
...
tl2.to("#page2 h1", { top: "-100%" });

gsap.registerPlugin(ScrollTrigger);

gsap.registerPlugin(ScrollTrigger);

gsap.to("#page4 #darkoverly3", {
  opacity: 0,
  delay: 1,
  scrollTrigger: {
    trigger: "#page4",
    ...
    scroller: "#main",
    scrub: true,
    markers: true // Remove this in production; it's for visualization
  }
});
...
// Animate h1 and h3 at the same time
tl3.to("#page4 h1", { top: "-100%" }, 0);
tl3.to("#page4 h3", { top: "-100%" }, 0);

// Animate the video size reduction
tl3.to("#page4 video", { scale: 0.9 }, 0);

gsap.to("#page5 #darkoverly5", {
  opacity: 0,
  delay: 1,
  scrollTrigger: {
    trigger: "#page5",
...
// Animate h1 and h3 at the same time
tl5.to("#page5 h1", { top: "-100%" }, 0);
tl5.to("#page5 h3", { top: "-100%" }, 0);
tl5.to("#page5 video",{ scale:0.9},0)
